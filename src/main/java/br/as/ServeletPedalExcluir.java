...
/**
 * Servlet implementation class ServeletPedalExcluir
 */
@WebServlet("/ServeletPedalExcluir")
public class ServeletPedalExcluir extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String query = "DELETE FROM pedal WHERE id=" + id;
		...
		if (status == 1) {
			out.println("<h3>A pedalada " + id + " foi excluida com sucesso!</h3>");
		}else {
